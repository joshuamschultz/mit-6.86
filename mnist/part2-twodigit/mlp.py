...
class MLP(nn.Module):
    ...
    def forward(self, x):
        ...
        out_1 = F.relu(self.linear1(xf))
        out_2 = F.relu(self.linear2(out_1))
        out_first_digit = self.linear_first_digit(out_2)
        out_second_digit = self.linear_second_digit(out_2)
